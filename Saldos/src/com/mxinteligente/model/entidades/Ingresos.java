...
public class Ingresos  implements java.io.Serializable {
    ...
    public Ingresos(IngresosId id) {
        this.id = id;
    }
    public Ingresos(IngresosId id, String concepto, BigDecimal cantidad) {
       this.id = id;
       this.concepto = concepto;
       this.cantidad = cantidad;
    }
   
    public IngresosId getId() {
        return this.id;
    }
    
    public void setId(IngresosId id) {
        this.id = id;
    }
	...
	public Catingresos getCategoria() {
		return categoria;
	}


	public void setCategoria(Catingresos categoria) {
